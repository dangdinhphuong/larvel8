				...
				editor.addCommand( 'insertToc', {
					...
					exec: function( editor )
					{
						...
						for ( var i = 0 ; i < nodes.count() ; i++ )
						{
							...
							tocItems = tocItems + '<div style="margin-left:'+level*40+'px; color: blue" id="' + id.toString() + '-toc" name="tableOfContents">' + '<a href="#' + id.toString() + '">' + text.getText().toString() + '</a></div>';
						}

						//output toc
						var tocNode = '<div class="bg-light border p-2" name="tableOfContents"><p name="tableOfContents" id="main-toc"><b>' + editor.lang.toc.ToC + '</b></p>' + tocItems + '</div>';
