                ...
                <div>
                    ...
                    <div class="position-relative form-group">
                        ...
                        <select name="status" id="status"
                            ...
                            <option value="1" {{ old('status', $item->status ?? null) == 1 ? "selected" : null }}>Hoạt động</option>
                            <option value="0" {{ old('status', $item->status ?? null) == 0 ? "selected" : null }}>Không hoạt động</option>
                        </select>
